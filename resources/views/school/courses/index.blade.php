                    ...
                    <table class="table table-bordered table-striped dataTable" id="example1_wrapper">
                        ...
                        @foreach($courses as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{  route('courses.show', $item->id) }}" title="View Course"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                    <a href="{{ url('/school/courses/' . $item->id . '/edit') }}" title="Edit Course"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                    {!! Form::open([
                                        'method' => 'DELETE',
